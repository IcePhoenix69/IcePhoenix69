...
Update of 15/10/2025 (EU format): Right now i started an apprenticeship at Cineca, a company in Italy, for 6 month, and i'm very happy.
Except the fact that i need to learn Java, Angular, TypeScript, SpringBoot, GraphQL and RestAPI in a month. I will have nightmares about it.

Update of 20/11/2025 (EU format): I have made a simple project to learn Java SpringBoot and use it instead of Express.js, then MongoDB connected with Docker.
...
Test framework:
 - [x] Mockito (for Spring)
 - [ ] Mocha (i don't like it but i used it in the past)
 - [ ] Cypress (not used but explored)

I want to learn properly for myself and for my portfolio:
 - [ ] C++ (people says it's good for making games, so why not)
 - [ ] Pixi.js (already seen, i'm curious)
 ...
 - [ ] JavaFX (because it's a cool thing to use)
